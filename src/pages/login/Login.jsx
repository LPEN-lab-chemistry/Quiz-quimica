...
function Login() {
  ...
  return (
    <div className={styles['login-container']}>
      <header className={styles['header']}>
        ...
        <div className={styles['right']}>
          <div className={styles['button-sobre']}>
            <Button width="small" height="small" theme="orange" fontSize="large">Sobre</Button>
          </div>
        </div>
      </header>
      ...
      <Button width="small" height="small" theme="white-green" fontSize="large">Criar Login</Button>
    </form>
    </div>
  );
}
